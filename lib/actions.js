...
module.exports = function(options) {
  ...
  /**
   * Checks if a callback for the model/action is defined and returns it (if any).
   *
   * @param {string} name Model name.
   * @param {string} action Action name.
   * @return {mixed} Callback reference or null on undefined callback.
   */
  ...
  return {
     ...
     *   + id:    Entity ID
     * req.headers:
     *   + x-remo-mw: Whether to delete entity using mongoose pre/post middleware.
     */
